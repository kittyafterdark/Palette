...
- Docked Palette now cancels Lumiverse's native full-UI zoom for its own tooling chrome while continuing to honor the independent `--lumiverse-font-scale`, preventing the editor from becoming miniature when the Theme UI Scale slider is below 1×.
